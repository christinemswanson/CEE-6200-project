# Christine Swanson 
# 3/21/2024
# data acquisition for Alexandria Bay daily mean water level data 
...
# Specify the station ID for Alexandria Bay 
station_id <- 8311062

wtlvl_abay_daily_mean_wtlvl__m_metadata <- coops_search(station_name = station_id,
                                                              begin_date = 20170101,
                                                              end_date = 20170531,
...
wtlvl_abay_daily_mean_wtlvl__m <- wtlvl_abay_daily_mean_wtlvl__m_metadata[[2]]

# save the daily average water level data at Alexandria Bay to a CSV file
write_csv(wtlvl_abay_daily_mean_wtlvl__m,
          "../data/historic/abay_daily_mean_wtlvl_NOAA.csv")
