...
# os.chdir("C:/Users/cms549/Box/projects/LOSLR/simulation/scripts")
...
if (
    ...
    def calculate_annNTS(x):
        ...
        ar = 0.7382 * boxcox
        annnts = np.exp(ar + 8.856)  # back transformation from boxcox
    ...
    # run through input CLIMATE CHANGE hydrologic files...CMS edit
    # filelist = os.listdir("../input/" + expName + "/hydro")
    path = "./input/" + expName + "/*.txt"
    filelist = glob(path)
